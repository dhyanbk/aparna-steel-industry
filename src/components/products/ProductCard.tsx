  ...
  return (
    ...
    >
      ...
      <div className="p-8 sm:p-10 flex flex-col flex-grow">
        <h3 className="text-2xl font-black mb-4 text-slate-900 tracking-tight group-hover:text-blue-600 transition-colors uppercase line-clamp-2">{name}</h3>
        ...
        <div className="space-y-3 mt-auto">
          <a
            ...
            className="flex items-center justify-between w-full bg-slate-50 hover:bg-green-50 text-slate-700 hover:text-green-700 p-4 rounded-2xl transition-all border border-slate-100 font-bold group/btn"
          >
          ...
          <div className="grid grid-cols-2 gap-3">
            <a
              ...
              className="flex items-center justify-center space-x-2 bg-blue-600 hover:bg-blue-700 text-white p-4 rounded-2xl transition-all shadow-lg shadow-blue-500/20"
            >
            ...
            <a
              ...
              className="flex items-center justify-center space-x-2 bg-slate-900 hover:bg-slate-800 text-white p-4 rounded-2xl transition-all"
            >
